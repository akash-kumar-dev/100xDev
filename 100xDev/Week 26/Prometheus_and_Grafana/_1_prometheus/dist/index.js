...
const requestTime_1 = require("./monitoring/requestTime");
const app = (0, express_1.default)();
app.use(express_1.default.json());
// app.use(middleware);
app.use(requestCount_1.requestCount);
app.use(activeRequests_1.activeRequestsMiddleware);
app.use(requestTime_1.httpRequestDurationMiddleware);
